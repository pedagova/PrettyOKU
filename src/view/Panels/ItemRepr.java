...
public class ItemRepr extends JPanel {
	...
	public ItemRepr(/* ItemVO it */) {
		// this.item = it;
		addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				// lanzar panel del item
	...
	private void initGUI() {
		...
		//----------------image-------------------------
		BufferedImage im = ViewUtilities.encodeImage(
		...
		//---------------tex-------------------------------
		// 50 256
		JTextArea textLabel = new JTextArea( showInfo("Producto para probar el codigo 3759Aa1 al acabar de hablar esto deberia estar cortahbf dbsdfbiusdfb iusdfbusdbufbsdbj bfsbfsjbfsbjfjb sdjbfjbsdf do"));
	...
	private String showInfo(String s) {
		
		StringBuffer info = new StringBuffer();		
		int i = findSpace(s.substring(0, 37));
		int j = findSpace(s.substring(i, i + 37));
	
		info.append("   " + s.substring(0, i) + "\n");
		info.append("   " + s.substring(i + 1, i + j + 1));
